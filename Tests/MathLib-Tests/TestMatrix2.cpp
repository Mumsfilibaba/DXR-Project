...
bool TestMatrix2()
{
    ...
    // Multiplication
    FMatrix2 Mat0 = FMatrix2::Rotation(Math::Constants::HalfPI);
    FMatrix2 Mat1 = FMatrix2::Rotation(Math::Constants::HalfPI);
    ...
    // Multiply a vector
    FMatrix2 Rot = FMatrix2::Rotation(Math::Constants::HalfPI);
