...
struct SDerived2 : public SBase2
{
...
void Delegate_Test()
{
...

    {
        ...
        // Members
        SBase* Base = new SDerived();
        Delegate.BindRaw(Base, &SBase::Func) ;
        std::cout << "Execute=" << Delegate.Execute(100)  << std::endl;

        Delegate.BindRaw(Base, &SBase::ConstFunc) ;
        std::cout << "Execute=" << Delegate.Execute(200)  << std::endl;

        Delegate.BindRaw(Base, &SDerived::Func) ;
        std::cout << "Execute=" << Delegate.Execute(300)  << std::endl;

        Delegate.BindRaw(Base, &SDerived::ConstFunc) ;
        ...
        TDelegate<int32(int32) > Member0 = TDelegate<int32(int32) >::CreateRaw(Base, &SBase::Func) ;
        Member0.Execute(100) ;
        TDelegate<int32()> Member01 = TDelegate<int32()>::CreateRaw(Base, &SBase::Func, 200) ;
        Member01.Execute();

        TDelegate<int32(int32) > Member1 = TDelegate<int32(int32) >::CreateRaw(Base, &SBase::ConstFunc) ;
        Member1.Execute(100) ;
        TDelegate<int32()> Member11 = TDelegate<int32()>::CreateRaw(Base, &SBase::ConstFunc, 200) ;
        Member11.Execute();

        TDelegate<int32(int32) > Member2 = TDelegate<int32(int32) >::CreateRaw(Base, &SDerived::Func) ;
        Member2.Execute(100) ;
        TDelegate<int32()> Member21 = TDelegate<int32()>::CreateRaw(Base, &SDerived::Func, 200) ;
        Member21.Execute();

        TDelegate<int32(int32) > Member3 = TDelegate<int32(int32) >::CreateRaw(Base, &SDerived::ConstFunc) ;
        Member3.Execute(100) ;

        TDelegate<int32()> Member31 = TDelegate<int32()>::CreateRaw(Base, &SDerived::ConstFunc, 200) ;
        Member31.Execute();
...

    {
        ...
        // Members
        SBase2* Base = new SDerived2();
        MultiDelegates.AddRaw(Base, &SBase2::Func) ;
        MultiDelegates.AddRaw(Base, &SBase2::ConstFunc) ;
        MultiDelegates.AddRaw(Base, &SDerived2::Func) ;
        MultiDelegates.AddRaw(Base, &SDerived2::ConstFunc) ;
