...
Bool Sandbox::Init()
{
    ...
    SampledTexture2D BaseTexture = TextureFactory::LoadSampledTextureFromMemory(Pixels, 1, 1, 0, EFormat::R8G8B8A8_Unorm);
    if (!BaseTexture)
    {
        return false;
    }
    ...
    SampledTexture2D BaseNormal = TextureFactory::LoadSampledTextureFromMemory(Pixels, 1, 1, 0, EFormat::R8G8B8A8_Unorm);
    if (!BaseNormal)
    {
        return false;
    }
    ...
    SampledTexture2D AlbedoMap = TextureFactory::LoadSampledTextureFromFile("../Assets/Textures/Gate_Albedo.png", TextureFactoryFlag_GenerateMips, EFormat::R8G8B8A8_Unorm);
    if (!AlbedoMap)
    {
        return false;
    }
    ...
    SampledTexture2D NormalMap = TextureFactory::LoadSampledTextureFromFile("../Assets/Textures/Gate_Normal.png", TextureFactoryFlag_GenerateMips, EFormat::R8G8B8A8_Unorm);
    if (!NormalMap)
    {
        return false;
    }
    ...
    SampledTexture2D AOMap = TextureFactory::LoadSampledTextureFromFile("../Assets/Textures/Gate_AO.png", TextureFactoryFlag_GenerateMips, EFormat::R8G8B8A8_Unorm);
    if (!AOMap)
    {
        return false;
    }
    ...
    SampledTexture2D RoughnessMap = TextureFactory::LoadSampledTextureFromFile("../Assets/Textures/Gate_Roughness.png", TextureFactoryFlag_GenerateMips, EFormat::R8G8B8A8_Unorm);
    if (!RoughnessMap)
    {
        return false;
    }
    ...
    SampledTexture2D HeightMap = TextureFactory::LoadSampledTextureFromFile("../Assets/Textures/Gate_Height.png", TextureFactoryFlag_GenerateMips, EFormat::R8G8B8A8_Unorm);
    if (!HeightMap)
    {
        return false;
    }
    ...
    SampledTexture2D MetallicMap = TextureFactory::LoadSampledTextureFromFile("../Assets/Textures/Gate_Metallic.png" , TextureFactoryFlag_GenerateMips, EFormat::R8G8B8A8_Unorm);
    if (!MetallicMap)
    {
        return false;
    }
