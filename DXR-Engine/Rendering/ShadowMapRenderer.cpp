...
void ShadowMapRenderer::RenderPointLightShadows(
    CommandList& CmdList, 
...
void ShadowMapRenderer::RenderDirectionalLightShadows(
    CommandList& CmdList,
    const SceneLightSetup& LightSetup,
    const Scene& Scene)
{
    ...
    if (UpdateDirLight)
    {
        ...
        CmdList.ClearDepthStencilView(
            LightSetup.DirLightShadowMapDSV.Get(),
        ...
        // Setup view
        CmdList.BindViewport(
            static_cast<Float>(LightSetup.ShadowMapWidth),
            static_cast<Float>(LightSetup.ShadowMapHeight),
            0.0f,
            1.0f,
            0.0f,
            0.0f);
...
Bool ShadowMapRenderer::CreateShadowMaps(SceneLightSetup& LightSetup)
{
    ...
    if (LightSetup.DirLightShadowMaps)
    {
        ...
        {
            LightSetup.DirLightShadowMapDSV->SetName("DirectionalLight ShaderResourceView");
        }
    }
    else
    {
