...
struct Float64
{
    ...
    FORCEINLINE Float64(double InFP64)
        : FP64(InFP64)
    {
    }
    ...
    FORCEINLINE void SetFloat(double InFP64) { FP64 = InFP64; }

    FORCEINLINE double GetFloat() const { return FP64; }

    FORCEINLINE Float64& operator=(double InFP64)
    {
        FP64 = InFP64;
        return *this;
    }
...
struct Float32
{
    ...
    FORCEINLINE Float32(float InFP32)
        : FP32(InFP32)
    {
    }
    ...
    FORCEINLINE void SetFloat(float InFP32) { FP32 = InFP32; }

    FORCEINLINE float GetFloat() const { return FP32; }

    FORCEINLINE Float32& operator=(float InFP32)
    {
        FP32 = InFP32;
        return *this;
    }
