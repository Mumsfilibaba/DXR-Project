...
namespace Internal
{
    ...
    inline auto _Invoke( FuncType&& Func, ArgTypes&&... Args )
    ...
    inline auto _Invoke( ReturnType ObjectType::* Func, InstanceType&& Obj, ArgTypes&&... Args )
    ...
    inline auto _Invoke( ReturnType ObjectType::* Member, InstanceType&& Obj )
...
{
	return Internal::_Invoke( Forward<FuncType>( Func ), Forward<ArgTypes>( Args )... );
}