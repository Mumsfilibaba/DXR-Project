...
/* Keys */
TStaticArray<EKey, 512>   CMacKeyMappings::KeyCodeFromScanCodeTable;
TStaticArray<uint16, 512> CMacKeyMappings::ScanCodeFromKeyCodeTable;

/* Buttons */
TStaticArray<EMouseButton, EMouseButton::MouseButton_Count> ButtonFromButtonIndex;
TStaticArray<uint8, EMouseButton::MouseButton_Count>        ButtonIndexFromButton;

void CMacKeyMappings::Init()
{
    /* Keys */
    Memory::Memzero( KeyCodeFromScanCode->Data(), sizeof( KeyCodeFromScanCode ) );
    Memory::Memzero( ScanCodeFromKeyCode, sizeof( KeyState ) );
    ...
    {
        if ( ButtonFromButtonIndex[Index] != EKey::Key_Unknown )
        {
