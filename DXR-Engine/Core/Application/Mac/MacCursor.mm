...
/* Implementation */
void CMacCursor::InitLookUpTable()
{
	Memory::Memzero(ButtonFromButtonIndex, sizeof(ButtonFromButtonIndex));
	Memory::Memzero(ButtonState, sizeof(ButtonState));
...
void CMacCursor::SetCursorPosition( CGenericWindow* InRelativeWindow, int32 x, int32 y ) const
{
	CGPoint NewPosition;
	if (InRelativeWindow)
	{
...
void CMacCursor::GetCursorPosition( CGenericWindow* InRelativeWindow, int32& OutX, int32& OutY ) const
{
