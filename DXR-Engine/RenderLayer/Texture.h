...
public:
    ...
    virtual class Texture2D* AsTexture2D()
    {
        return nullptr;
    }
    virtual class Texture2DArray* AsTexture2DArray()
    {
        return nullptr;
    }
    virtual class TextureCube* AsTextureCube()
    {
        return nullptr;
    }
    virtual class TextureCubeArray* AsTextureCubeArray()
    {
        return nullptr;
    }
    virtual class Texture3D* AsTexture3D()
    {
        return nullptr;
    }
    ...
    const ClearValue& GetOptimalClearValue() const
    {
...
public:
    ...
    virtual class RenderTargetView* GetRenderTargetView() const
    {
        return nullptr;
    }

    // Returns a DepthStencilView if texture is created with TextureFlag_DSV
    virtual class DepthStencilView* GetDepthStencilView() const
    {
        return nullptr;
    }

    // Returns a UnorderedAccessView if texture is created with TextureFlag_UAV
    virtual class UnorderedAccessView* GetUnorderedAccessView() const
    {
        return nullptr;
    }
