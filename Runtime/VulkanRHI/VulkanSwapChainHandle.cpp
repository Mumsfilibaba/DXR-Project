...
FVulkanSwapChainHandle::FVulkanSwapChainHandle(FVulkanDevice* InDevice)
...
FVulkanSwapChainHandle::~FVulkanSwapChainHandle()
{
...
bool FVulkanSwapChainHandle::Initialize(const FVulkanSwapChainCreateInfo& CreateInfo)
{
...
bool FVulkanSwapChainHandle::GetSwapChainImages(VkImage* OutImages)
{
...
VkResult FVulkanSwapChainHandle::Present(FVulkanQueue& Queue, FVulkanSemaphore* WaitSemaphore)
{
...
VkResult FVulkanSwapChainHandle::AquireNextImage(FVulkanSemaphore* AquireSemaphore)
{
