...
#define VULKAN_DEFAULT_CONSTANT_BUFFER_COUNT                 (8)
#define VULKAN_DEFAULT_SHADER_RESOURCE_VIEW_COUNT            (16)
#define VULKAN_DEFAULT_UNORDERED_ACCESS_VIEW_COUNT           (8)
#define VULKAN_DEFAULT_SAMPLER_STATE_COUNT                   (8)