...
typedef TSharedRef<class FVulkanSwapChainHandle> FVulkanSwapChainHandleRef;

struct FVulkanSwapChainCreateInfo
{
    FVulkanSwapChainHandle* PreviousSwapChain = nullptr;
...
class FVulkanSwapChainHandle : public FVulkanDeviceChild, public FVulkanRefCounted
{
public:
    FVulkanSwapChainHandle(FVulkanDevice* InDevice);
    ~FVulkanSwapChainHandle();
