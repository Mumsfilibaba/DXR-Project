...
struct IPlatformWindow : public IRefCounted
{
     ...
     * 
     * @param InDesc Contains the parameters needed to create and configure the window.
     * @return True if initialization was successful, otherwise false.
     */
    virtual bool Initialize(const FPlatformWindowDesc& InDesc) = 0;

    /** @brief Destroys the platform-specific handle for this window. The IPlatformWindow object may still exist, but the underlying OS window becomes invalid. */
     ...
     */
    virtual void Show(bool bFocus = true) = 0;
     ...
     */
    virtual bool IsChildWindow(const TSharedRef<IPlatformWindow>& ParentWindow) const = 0;
     ...
     */
    virtual void GetTitle(String& OutTitle) const = 0;
     ...
     */
    virtual void SetWindowPos(int32 x, int32 y) = 0;
     ...
     */
    virtual void SetWindowShape(const FWindowShape& Shape, bool bMove) = 0;
     ...
     */
    virtual void GetWindowShape(FWindowShape& OutWindowShape) const = 0;
     ...
     */
    virtual void GetFullscreenInfo(uint32& OutWidth, uint32& OutHeight) const = 0;
     ...
     */
    virtual void SetStyle(EWindowStyleFlags Style) = 0;
     ...
     */
    virtual void SetAcceptsInput(bool bInAcceptsInput) = 0;
     ...
     */
    virtual bool GetAcceptsInput() const = 0;
     ...
     */
    virtual void SetPlatformHandle(void* InPlatformHandle) = 0;
