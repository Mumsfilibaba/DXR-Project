...
class FPointLightShadowGS : public FPointLightShadowRules
{
    ...
    {
        const FPermutation Permutation = FPermutation(Desc.PermutationID);
        return Permutation.Get<FPointLightPassKind>() == ECubeMapRenderPassType::GeometryShaderSinglePass && FPointLightShadowRules::ShouldCompilePermutation(Desc);
    }
};
...
class FCascadeShadowGS : public FCascadeShadowRules
{
    ...
    {
        const FPermutation Permutation = FPermutation(Desc.PermutationID);
        return Permutation.Get<FCascadePassKind>() == ECascadeRenderPassType::GeometryShaderSinglePass && FCascadeShadowRules::ShouldCompilePermutation(Desc);
    }
};
...
class FShadowMaskCS
{
    ...
    using FPermutation = TShaderPermutation< FCSMFilterFunctionDim, FCSMFilterModeDim, FCSMDebug, FCSMRotateSamples, FCSMCascadeFromProjection, FCSMBlendCascades, FCSMNumSamples>;
