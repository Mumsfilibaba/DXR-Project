...
public:
    ...
    virtual void CopyBuffer(FRHIBuffer* Destination, FRHIBuffer* Source, const SRHICopyBufferInfo& CopyInfo) override final;
    virtual void CopyTexture(FRHITexture* Destination, FRHITexture* Source) override final;
    virtual void CopyTextureRegion(FRHITexture* Destination, FRHITexture* Source, const SRHICopyTextureInfo& CopyTextureInfo) override final;
