...
struct FRHIDevice
{
    ...
    /** @return D3D12: IDXGIAdapter*. Vulkan: VkPhysicalDevice. Metal: id<MTLDevice>. Null: nullptr. */
    ...
    /** @return D3D12: ID3D12CommandQueue*. Vulkan: nullptr. Metal: id<MTLCommandQueue>, the same queue as direct. Null: nullptr. */
