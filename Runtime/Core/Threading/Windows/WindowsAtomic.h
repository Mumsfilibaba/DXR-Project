...
public:
    ...
    {
        return PlatformInterlocked::CompareExchange( (int8*)Src, 0, 0 );
    }

    static FORCEINLINE int16 Read( volatile const int16* Source )
    {
        return PlatformInterlocked::CompareExchange( (int16*)Src, 0, 0 );
    }

    static FORCEINLINE int32 Read( volatile const int32* Source )
    {
        return PlatformInterlocked::CompareExchange( (int32*)Src, 0, 0 );
    }

    static FORCEINLINE int64 Read( volatile const int64* Source )
    {
        return PlatformInterlocked::CompareExchange( (int64*)Src, 0, 0 );
    }
    ...
    {
        return PlatformInterlocked::Exchange( (int8*)Dest, Value );
    }

    static FORCEINLINE void Store( volatile int16* Dest, int16 Value  )
    {
        return PlatformInterlocked::Exchange( (int16*)Dest, Value );
    }

    static FORCEINLINE void Store( volatile int32* Dest, int32 Value  )
    {
        return PlatformInterlocked::Exchange( (int32*)Dest, Value );
    }

    static FORCEINLINE void Store( volatile int64* Dest, int64 Value  )
    {
        return PlatformInterlocked::Exchange( (int64*)Dest, Value );
    }
