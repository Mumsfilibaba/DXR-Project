...
public:
    ...
    {
        return reinterpret_cast<CharType*>(FMemory::Memcpy(Dest, Source, InLength * sizeof(CharType)));
    }
    ...
    {
        return reinterpret_cast<CharType*>(FMemory::Memmove(Dest, Source, InLength * sizeof(CharType)));
    }
...
public:
    ...
    {
        return reinterpret_cast<CharType*>(FMemory::Memcpy(Dest, Source, Length * sizeof(CharType)));
    }
    ...
    {
        return reinterpret_cast<CharType*>(FMemory::Memmove(Dest, Source, Length * sizeof(CharType)));
    }
