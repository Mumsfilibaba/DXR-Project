...
static TSharedPtr<SImage2D> LoadMaterialTexture(const FString& Path, const FString& Filename)
{
...
bool COBJLoader::LoadFile(const FString& Filename, SSceneData& OutScene, bool ReverseHandedness)
{
