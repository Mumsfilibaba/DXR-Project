...
{
    FMetalTextureRef NewTexture = new FMetalTexture(GetDeviceContext(), InTextureDesc, InInitialState);
...
{
    FMetalBufferRef NewBuffer = new FMetalBuffer(GetDeviceContext(), InBufferDesc, InInitialState);
