...
class CMetalRayMissShader : public FRHIRayMissShader, public FMetalRayTracingShader
{
public:

    CMetalRayMissShader(FMetalDeviceContext* InDevice, const TArray<uint8>& InCode)
        : FRHIRayMissShader()
        , FMetalRayTracingShader(InDevice, InCode)
    { }
